print("========================================")
print("Displaying Prime Numbers Between 1 and 100\n")

for PrimeN in range (1, 101):              # LOOP: Numbers 1-100 will be processed.
    CountN = 0
    for i in range(2, (PrimeN//2 + 1)):    # LOOP: The number is 'Between 2' and the 'PrimeN Divide by 2, plus 1'.
        if(PrimeN % i == 0):               # Checks for a remainder / Decimal place. Proceed to next line, if 0
